    ...
    >
      ...
      >
        <div className="space-y-4">
          <input
            type="email"
            placeholder="Studio Member Email"
            value={email}
        ...
        >
          {isLoading ? "Validating..." : "Enter Studio"}
        </button>
        ...
        <div className="relative my-12">
          ...
          <div className="relative flex justify-center text-[8px] uppercase tracking-[0.3em] font-bold">
            <span className="bg-[#FAF8F6] px-4 text-black/30">Artisan Social Access</span>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
            <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-black/20">Artisan Account Required</p>
            <Link 
                href="/auth/signup"
    ...
    <div className="min-h-screen bg-[#FAF8F6]">
      <section className="container-pad py-12 lg:py-20">
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="mt-4 text-xs uppercase tracking-widest text-black/40 max-w-md">Access your artisan profile.</p>
        </div>
        
        <Suspense fallback={
          <div className="mt-10 mx-auto max-w-lg rounded-[2.5rem] border border-black/5 bg-white/40 p-10 flex items-center justify-center min-h-[400px]">
            <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-black/20 animate-pulse">Gathering artisan credentials...</p>
          </div>
        }>
          <LoginForm />
        </Suspense>
